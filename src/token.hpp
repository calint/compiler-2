...
class token{public:
	...
	inline token()
		:ws_before{unique_ptr<const char[]>(new char[1]{0})},token_start_char_{0},name_{unique_ptr<const char[]>(new char[1]{0})},token_end_char_{0},ws_after{unique_ptr<const char[]>(new char[1]{0})}
		{}
