...
;   [30:17] 2
    mov r13, 2
;   [30:17] bounds check
;   [30:17] allocate scratch register -> r12
;   [30:17] line number
    mov r12, 30
    test r13, r13
    cmovs rbp, r12
    ...
    cmovge rbp, r12
    jge panic_bounds
;   [30:17] free scratch register 'r12'
    imul r13, 20
    add r14, r13
...
;   [30:34] 1
    mov r12, 1
;   [30:34] bounds check
;   [30:34] allocate scratch register -> r11
;   [30:34] line number
    mov r11, 30
    test r12, r12
    cmovs rbp, r11
    ...
    cmovge rbp, r11
    jge panic_bounds
;   [30:34] free scratch register 'r11'
    imul r12, 20
    add r13, r12
