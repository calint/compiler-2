...
./baz --target=rv32i-fpga --vars=131072 --checks=upper,lower,line prog-uart.baz >/dev/null
...
openFPGALoader --offset $FIRMWARE_FLASH_OFFSET --external-flash "$FIRMWARE_FILE" --freq 1000000
